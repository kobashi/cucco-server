...
現在は**ゼミ内での試用期間**。フィードバックを受けて調整したうえで v1.0.0 と
する想定なので、仕様・UIは変わる可能性がある。

- 試用でとくに見たい点、既知の制約は[CHANGELOG](CHANGELOG.md)の
  「v1.0.0b1 — 試用版」を参照
...
カード演出付きプレイ用)まで実装済み、テスト341件全てパス。複数回のレビュー(Fable5)を経て主要な
