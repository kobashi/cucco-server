...
- **カンビオ/ノンカンビオ**: 自分の手番のとき表示される。カンビオは右隣の
  ...
  「クク宣言」ボタンも並ぶ=ボタン3つ)
- **クク宣言**: クク札を持っているときに宣言できる。自分の手番/親の「どうぞ」の
  場面ではボタンとして並び、それ以外の手番の合間には緊急モーダル(点滅+
  カウントダウン)として届く(モーダルは自分にしか表示されない)。いずれも
  押すとディールが即終了する
...
| クク宣言(手番) | クク札(44枚中2枚)を持つ手番(親なら「どうぞ」の場面)まで対局する | 「クク宣言」ボタンが手番/「どうぞ」の選択肢に加わり、押すとディールが即終了すること |
| クク宣言(手番外) | クク札を持ったまま他プレイヤーの手番の合間になる | 点滅する緊急モーダルとカウントダウンが割り込み表示され、宣言後にディールが即終了すること |
